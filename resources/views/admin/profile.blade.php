                    ...
                    <div class="row">
                        <div class="col m3 s12">
                            <ul>
                                <li>
                                    <div class="user-view">
                                        <a href="#!"><img id="previewing" style="width: 180px;height: 180px;" class="circle" src="{{!is_null(\Illuminate\Support\Facades\Auth::user()->profile_picture_url)?'/storage/'.\Illuminate\Support\Facades\Auth::user()->profile_picture_url:'/images/profile_placeholder.jpg'}}"/></a>
                                    </div>
                                </li>
                            </ul>
                        </div>
