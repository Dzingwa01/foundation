    ...
    <div class="" style="padding:2em;">
        ...
        <div class="row">
            ...
            <form id="save-nominee-details-form" class="col s12 card hoverable">
                ...
                <div class="row" style="margin-top: 2em;">
                    <div class="input-field col m6 s12">
                        <select  required id="title">
                            ...
                            <option value="Mr" {{isset($nominee)&&$nominee->title=='Mr'?'selected':''}}>Mr</option>
                            <option value="Mrs"  {{isset($nominee)&&$nominee->title=='Mrs'?'selected':''}}>Mrs</option>
                            <option value="Ms"  {{isset($nominee)&&$nominee->title=='Ms'?'selected':''}}>Ms</option>
                        </select>
                    </div>

                    <div class="input-field col m6 s12">
                        <input required id="national_id_number" type="text" class="validate" value="{{isset($nominee)?$nominee->national_id_number:''}}">
                        <label for="national_id_number">National ID Number</label>
                    </div>
                </div>
                <div class="row">
                    <div class="input-field col m6">
                        <input required id="name" type="text" class="validate" value="{{isset($nominee)?$nominee->name:''}}">
                        <label for="name">Name</label>
                    </div>
                    <div class="input-field col m6">
                        <input required name="surname" id="surname" type="text" class="validate" value="{{isset($nominee)?$nominee->surname:''}}">
                ...
                <div class="row">
                    <div class="input-field col m6">
                        <select name="gender" required id="gender">
                            <option value="Female" {{!$nominee->gender=='Male'?'selected':''}}>Female</option>
                            <option value="Male" {{$nominee->gender=='Male'?'selected':''}}>Male</option>
                        </select>
                ...
                <div class="row">
                    <div class="input-field col m6">
                        <input name="email" required id="email" type="email" class="validate" value="{{isset($nominee)?$nominee->email:''}}">
                        <label for="email">Email</label>
                    </div>
                    <div class="input-field col m6">
                        <input name="contact_number"  required id="contact_number" type="tel" class="validate" value="{{isset($nominee)?$nominee->contact_number:''}}">
                ...
                <div class="row">
                <div class="input-field col m6 s12" >
                    <input name="date_of_birth" id="date_of_birth" required type="date" class="validate" value="{{isset($nominee)?$nominee->date_of_birth:''}}">
                    <label for="date_of_birth">Date Of Birth</label>
                </div>
                <div class="input-field col m6 s12">
                    <input required name="relationship" id="relationship" type="text" class="validate" value="{{isset($nominee)?$nominee->relationship:''}}">
                ...
                <div class="row">
                    <div class="col offset-m4">
                        ...
                        <a href="{{url('funeral-cover-edit/'.$policy->id)}}" style="margin-left:2em;" class=" waves-effect waves-green btn">Next<i
            ...
            $(document).ready(function () {
                ...
                $('#save-nominee-details-form').on('submit', function (e) {
                    ...
                    if($('#title').val()=='select-title'){
                        ...
                        formData.append('is_covered', $('#is_covered').val());
                        formData.append('policy_number', $('#policy_number').val());

                        $.ajax({
                            url: "{{ url('nominees/update/'.$nominee->id) }}",
                            processData: false,
                            contentType: false,
                            data: formData,
                            type: 'post',
