...
<div class="navbar-fixed">
    <nav class="white" role="navigation" style="height: 5em;">
        <div class="nav-wrapper">
            ...
            <a id="logo-container" href="{{url('/home')}}" class="brand-logo center"><img src="/images/foundation-logo.png" style="height: 68px;width: 68px;" />
            </a>
    ...
    <ul id="slide-out" class="sidenav ">
                ...
                <div class="collapsible-body" >
                    <ul>
                        <li><a style="color:black;font-weight: bolder" class="" href="{{url('users')}}"><i
                                        class="tiny material-icons">account_circle</i>Users List</a></li>
        ...
        <ul class="collapsible popout" style="margin-top:1em;">
            <li>
                <div class="collapsible-header" style="color:black;font-weight: bolder"> <i class="tiny material-icons">business</i><a href="{{url('branches')}}" class="" style="color:black;"> Manage Branches</a>
                </div>
                <div class="collapsible-body" >
                </div>
            </li>
